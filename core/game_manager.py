...
from ..data.data_classes import GameState, Position, CellState
from ..data.constants import GAME_DAY_LENGTH, MINUTES_PER_SECOND, FIELD_WIDTH, FIELD_HEIGHT
from .player import Player
from .field import Field
from ..systems.plants import PlantSystem
from ..systems.forage import ForageSystem
from ..systems.storage import StorageSystem
...
class GameManager:
    ...
    def load_game(self, filename: str = "savegame.json") -> bool:
        try:
            ...
            # Load field state
            from data_classes import CellType
            for y in range(FIELD_HEIGHT):
                for x in range(FIELD_WIDTH):
